...
echo "Downloading Hytale starter..."
if ! curl -sSL -f https://github.com/mraliscoder/hytale-starter/releases/latest/download/hytale-starter -o hytale-starter; then
    echo "ERROR: Failed to download starter script"
    exit 1
fi
